...
const AboutPage: React.FC = () => {
  return (
    <div className="space-y-8">
      ...
      {/* Header */}
      <div>
        <h1 className="mb-2">About Feedback360</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="card flex items-start gap-4">
          ...
          <div>
            <h2 className="mb-2">Insightful Analytics</h2>
        ...
        <div className="card flex items-start gap-4">
          ...
          <div>
            <h2 className="mb-2">Structured Reviews</h2>
            <p className="text-gray-600 text-sm">
        ...
        <div className="card flex items-start gap-4">
          ...
          <div>
            <h2 className="mb-2">Customer-Centric Design</h2>
            <p className="text-gray-600 text-sm">
        ...
        <div className="card flex items-start gap-4">
          ...
          <div>
            <h2 className="mb-2">Secure & Reliable</h2>
            <p className="text-gray-600 text-sm">
